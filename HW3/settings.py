...
#
#  heroku config:set DJANGO_SECRET_KEY='h##!+x8ip5iy%=og!4db7*f)syom@6yv8di%*_yg+jj(&_7@_%'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'h##!+x8ip5iy%=og!4db7*f)syom@6yv8di%*_yg+jj(&_7@_%'
...
# if the environment variable is not defined then default to HW3_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'HW3_db.sqlite3')),
}
